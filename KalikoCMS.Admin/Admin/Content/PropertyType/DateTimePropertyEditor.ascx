...
<div class="form-group">
    ...
    <asp:Panel ID="DateControl" runat="server" CssClass="controls col-xs-4">
        <div class="input-group date">
            <asp:TextBox runat="server" ID="ValueField" CssClass="form-control narrow-input" /><span class="input-group-addon add-on"><i data-time-icon="icon-time" data-date-icon="icon-calendar" class="icon-time"></i></span>
        </div>
